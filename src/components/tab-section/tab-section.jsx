    ...
    <section className="tab-section">
      ...
      <div className="options-tabs">
        <div className="options-tabs__tabs-wrapper">
          <input className="visually-hidden" checked={value === 1} onChange={handleTabChange} type="radio" value="1" name="inset" id="tab_1"/>
          <label className="options-tabs__tab" htmlFor="tab_1" tabIndex="0">
            <span>Характеристики</span>
          </label>
          <input className="visually-hidden" checked={value === 2} onChange={handleTabChange} type="radio" name="inset" value="2" id="tab_2"/>
          <label className="options-tabs__tab" htmlFor="tab_2" tabIndex="0">
            <span>Отзывы</span>
          </label>
          <input className="visually-hidden" checked={value === 3} onChange={handleTabChange} type="radio" name="inset" value="3" id="tab_3"/>
